...
numbers_filtered = list(filter(lambda number: number % 2 == 0 or (number % 2 != 0 and number <= 47), numbers))

print(*numbers_filtered)

numbers_mapped = map(lambda number: number // 2 if number % 2 == 0 else number, numbers_filtered)
